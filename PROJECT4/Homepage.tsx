      ...
      <View style={styles.popularJobs}>
        <View style={styles.popularCard}>
          <View style={styles.popularCardContent}>
            ...
            <View>
              <Text style={styles.popularText1}>Text1</Text>
              <Text style={styles.popularText2}>Text2</Text>
            </View>
          </View>
          <View>
            <Text style={styles.popularText3}>Text3</Text>
            <Text style={styles.popularText4}>Text4</Text>
          </View>
        </View>
        <View style={styles.popularCard}>
          <View style={styles.popularCardContent}>
